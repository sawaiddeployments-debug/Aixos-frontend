...
import { CheckCircle, ClipboardCheck, Upload, CalendarClock, Clock, XCircle } from 'lucide-react';

/**
 * Shown after a maintenance inquiry is accepted — matches “Inquiry accepted” next-step UI.
 */
const PartnerPostAcceptCard = ({ inquiryId, itemId, onUploadReport, onScheduleDate, approvalStatus, scheduledDate }) => {
